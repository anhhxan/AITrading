...
async function run() {
  const { data } = await supabase.from("robot_configs").select("*").eq("robot_id", "33f9c37d-64ef-4a01-8aa3-05a1d897c193").eq("status", "ACTIVE").single();
  console.log(data ? data.risk_config : "No active config");
}
run();
