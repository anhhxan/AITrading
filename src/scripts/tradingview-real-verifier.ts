...
async function bootstrap() {
    ...
    riskEngine.registerRobotConfig('RobotXAU', { tradingViewSymbol: 'XAUUSD', executionSymbol: 'XAUUSD', timeframe: '15m', accountBalance: 10000, positionAllocationPercent: 20,  leverage: 1 });
