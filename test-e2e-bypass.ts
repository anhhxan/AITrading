...
import { RuntimeManager } from './src/core/engine/RuntimeManager';
...
async function run() {
    ...
    // Create a payload that guarantees touch
    // Current price is ~78890
    // If we send LONG with B4 = 78895 and B3 = 79000
    // The Retracement Zone will be [78885, 78895]. Price 78890 is inside.
    const payload = {
        direction: "LONG",
    ...
    await adapter.handleWebhook(payload, '8bf86ec5-41a4-4d11-9998-d486d23db18b', 'test-local-trace');
