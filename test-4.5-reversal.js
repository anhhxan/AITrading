...
async function run() {
  ...
  await sendWebhook({
    action: "BUY", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1800000000000,
  ...
  await sendWebhook({
    action: "BUY", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1800000900000,
  ...
  await sendWebhook({
    action: "BUY", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1800001800000,
  ...
  await sendWebhook({
    action: "SELL", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1800002700000,
  ...
  await sendWebhook({
    action: "SELL", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1800003600000,
    open: 109000, high: 112000, low: 108000, close: 107000, volume: 10,
    indicator: { length: 20, source: "close", mult: 2.0, mult2: 1.0 },
    plots: { upper: 100000, upper2: 105000, basis: 80000, lower2: 70000, lower: 75000 }
  });
  await delay(3000);
  ...
  await sendWebhook({
    action: "SELL", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1800004500000,
    open: 107000, high: 108000, low: 104500, close: 105500, volume: 10,
    indicator: { length: 20, source: "close", mult: 2.0, mult2: 1.0 },
    plots: { upper: 100000, upper2: 105000, basis: 80000, lower2: 70000, lower: 75000 }
  });
  ...
  const { data: hist } = await supabase.from('trade_history').select('*').eq('robot_id', robotId).order('created_at', { ascending: false }).limit(2);
