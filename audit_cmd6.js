...
async function run() {
  ...
  const target = cmds.find(c => (c.command_id && c.command_id.startsWith("6dd26750")) || (c.correlation_id && c.correlation_id.includes("6dd26750")));
  if (!target) {
    console.log("Not found in IDs or Correlation IDs");
  } else {
