...
import { PaperExecutionEngine } from './src/core/engine/execution/PaperExecutionEngine';
...
async function run() {
    ...
    const trace = EventFactory.createTrace('test-correlation-id', 'test-event-id', 'test-source', 100);
