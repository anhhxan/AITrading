...
async function run() {
  ...
  await sendWebhook({
    action: "BUY", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1820000000000,
  ...
  await sendWebhook({
    action: "BUY", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1820000900000,
  ...
  await sendWebhook({
    action: "BUY", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1820001800000,
  ...
  await sendWebhook({
    action: "SELL", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1820002700000,
  ...
  await sendWebhook({
    action: "SELL", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1820003600000,
  ...
  await sendWebhook({
    action: "SELL", tvSymbol: "BINANCE:BTCUSDT", timeframe: "15m", barTimestamp: 1820004500000,
    open: 104000, high: 106000, low: 102000, close: 103000, volume: 10,
    indicator: { length: 20, source: "close", mult: 2.0, mult2: 1.0 },
    plots: { upper: 100000, upper2: 105000, basis: 80000, lower2: 70000, lower: 75000 }
  });
