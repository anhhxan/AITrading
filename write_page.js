        ...
        <div className="space-y-6">
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden p-6">
            ...
            <div className="flex flex-wrap gap-4">
               ...
               <Link 
                 href={\`/dashboard/robots/\${robot.id}/pipeline\`}
                 className="px-4 py-2 border border-slate-300 rounded-lg text-sm font-medium text-slate-700 hover:bg-slate-50 inline-flex items-center"
               >
                 <Activity className="w-4 h-4 mr-2" /> Open Pipeline Monitor
               </Link>
            </div>
          </div>
...
`
fs.writeFileSync('src/app/dashboard/robots/[id]/page.tsx', pageContent, 'utf8')
